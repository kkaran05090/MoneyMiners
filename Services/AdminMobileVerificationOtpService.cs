...
{
    public sealed class AdminMobileVerificationOtpService
        : IAdminMobileVerificationOtpService
    {
        private static readonly TimeSpan OtpValidity =
            TimeSpan.FromMinutes(5);

        private readonly IAdminMobileVerificationOtpRepository
            _otpRepository;
        ...
        public AdminMobileVerificationOtpService(
            IAdminMobileVerificationOtpRepository otpRepository,
        ...
        public async Task<AdminMobileVerificationOtpChallengeResult> SendAsync(
            long adminUserId,
            string phoneNumber,
        ...
        {
            var hashInput =
                $"AdminMobileVerificationOTP|{adminUserId}|{phoneNumber}|{otpCode}";
